...
function Image2Banner({ title, description }) {
  return (
    <div className="relative w-[400px] m-7 h-[250px] overflow-hidden">
      <div className="absolute inset-0">
        <Image src={image8} alt={title} layout="fill" objectFit="cover" />
      </div>
